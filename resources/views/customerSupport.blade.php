...
<head>
    ...
    @vite(['resources/css/app.css','resources/css/custom.css', 'resources/js/app.js', 'resources/css/customerSupport.css'])
</head>
    <body>
        <header>
            <nav>
        ...
        <footer class="flex justify-center">
            ...
            <p class="flex ">@2024 Stonkspizza Alle rechten voorbehouden</p>
        </footer>
    </body>
</html>
