...
<head>
    ...
    <title>Create Pizza's</title>
    @vite(['resources/css/app.css', 'resources/css/custom.css', 'resources/css/create.css' ,'resources/js/app.js', 'resources/js/custom.js' ])
</head>
<body>
...
<div class="grid grid-rows-3">
    <div class="grid text-center">
        <form class="Form" method="post" action="{{route('crudpizza.store')}}">
            @csrf
            Pizza name: <input id="PizzaName" name="PizzaName" type="text">
            Pizza Price: <input id="PizzaPrice" name="PizzaPrice" type="text">
            Pizza Image: <input id="PizzaImage" name="PizzaImage" type="text">
            Pizza Ingrediënts: <input id="PizzaIngrediënts" name="PizzaIngrediënts" type="text">
        </form>
    </div>
    <div class="">
        items
