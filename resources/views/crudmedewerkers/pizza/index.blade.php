...
<header>
    ...
    <nav style="display: flex; flex-direction: row; width: 100%; flex-wrap: wrap; align-content: center; align-items: center; justify-content: center;">
        <ul>
            ...
            <li><a href="/crudmedewerkers/edit">Edit Pizza's</a></li>
            <li><a href="/crudmedewerkers/create">Creat Pizza's</a></li>
            <li><a href="/crudmedewerkers/index">Delete Pizza's</a></li>
        </ul>
    </nav>
</header>
